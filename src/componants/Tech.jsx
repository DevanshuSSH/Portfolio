import { BiLogoBootstrap, BiLogoJavascript, BiLogoMongodb, BiLogoNodejs, BiLogoReact, BiLogoTailwindCss, BiLogoTypescript } from "react-icons/bi"
    ...
    return (
        <div id="Tech" className="flex min-h-[70vh] w-full flex-col items-center justify-center gap-16 md:gap-32">
            ...
            <div className="flex flex-wrap items-center justify-center gap-10 p-5">
                ...
                >
                    <BiLogoBootstrap className="cursor-pointer text-[80px] text-indigo-700 transition-all duration-300 hover:-translate-y-5 sm-text[100px] md:text-[120px]" />
                </motion.div>
